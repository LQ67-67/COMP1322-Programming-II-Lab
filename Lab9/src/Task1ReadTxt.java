...
import java.io.FileReader; // opens a text file for reading characters
...
public class Task1ReadTxt {
    public static void main(String[] args) {
        try (BufferedReader reader = new BufferedReader(new FileReader("Lab9/sample.txt"))) { // open and read the file
            ...
            String line;  // store each line temporarily
            ...
            System.out.println("Error: " + e.getMessage()); // if file is missing or cannot be read, print error
        }
    }
}